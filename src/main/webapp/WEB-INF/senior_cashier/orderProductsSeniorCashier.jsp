    ...
    <div class="mb-5">
        <table class="table">
            ...
            <tr>
                ...
                <th scope="col"><fmt:message key="cancelProduct"/></th>
            </tr>
            </thead>
            <tbody>
            <c:forEach var="product" items="${products}">
                <tr>
                    ...
                    <td>
                        <form action="/senior_cashier/orders/<c:out value="${orderId}"/>/<c:out value="${product.key.id}"/>"
                    ...
                    <td>
                        <form action="/senior_cashier/orders/cancel/<c:out value="${orderId}"/>/<c:out value="${product.key.id}"/>"
                              method="post">
