...
public class OrderQueries {
    ...
    public static final String FIND_ALL_WITH_RELATIONSHIPS = "select * from orders o left join order_products op on o.id = op.order_id" +
            " left join products p on p.id = op.product_id join users u on u.id = o.user_id";
    ...
    public static final String FIND_BY_ID_WITH_RELATIONS = FIND_ALL_WITH_RELATIONSHIPS + " where o.id = ?";
    public static final String FIND_BY_STATUS_WITH_RELATIONS = FIND_ALL_WITH_RELATIONSHIPS + " where status = ?";
    public static final String FIND_BY_STATUS_ORDER_BY_DATE_DESC_WITH_RELATIONS = FIND_ALL_WITH_RELATIONSHIPS + " where o.id = ?";
}
