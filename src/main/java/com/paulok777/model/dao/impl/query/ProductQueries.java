...
public class ProductQueries {
    ...
    public static final String FIND_BY_ID = FIND_ALL + " where product_id = ?";
    ...
    public static final String UPDATE = "update products set code = ?, name = ?, price = ?, measure = ?, amount = ? where product_id = ?";
    public static final String UPDATE_AMOUNT = "update products set amount = ? where product_id = ?";
    public static final String DELETE = "delete from products where product_id = ?";
}
